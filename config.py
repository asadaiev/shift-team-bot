...
class Config:
    ...
    # Database
    DB_PATH: str = os.environ.get("DB_PATH", "stats.db")  # Deprecated, kept for backward compatibility
    MONGODB_URI: str = os.environ.get("MONGODB_URI", "").strip()
    if not MONGODB_URI:
        raise SystemExit("Set MONGODB_URI env var, e.g. export MONGODB_URI='mongodb+srv://...'")
